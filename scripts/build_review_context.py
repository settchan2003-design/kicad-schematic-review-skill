...
def discover_checklists(
    ...
    domain_rules = [
        ...
        (
            references / "checklists" / "buck_power_stage_schematic.md",
            [
                "buck",
                "step-down",
                "step down",
            ...
            "Buck converter schematic-rule or power-stage sizing evidence found.",
        ),
        (
        ...
        (
            references / "checklists" / "i2c_pullup_schematic.md",
            [
                "i2c",
                "i²c",
                "scl",
            ...
            "I2C/open-drain bus pull-up evidence found.",
        ),
        (
            references / "checklists" / "rs485_schematic.md",
            [
                "rs485",
                "rs-485",
                "rs422",
            ...
            "RS-485/RS-422 bus, termination, failsafe, or direction-control evidence found.",
        ),
        (
            references / "checklists" / "esd_protection_schematic.md",
            [
                "esd",
                "tvs",
                "iec 61000-4-2",
            ...
            "ESD/TVS protection or exposed-interface evidence found.",
        ),
        (
